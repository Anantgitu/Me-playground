...
const API_URL = "https://me-playground-backend-l2a3.onrender.com";
...
function App() {
    ...
    if (loading) {
        return <div className="text-center text-gray-400 p-8">Loading Portfolio...</div>;
    }
    ...
    if (!profile) {
        return <div className="text-center text-gray-400 p-8">No profile available.</div>;
    }
